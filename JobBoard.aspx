<%@ Page Title="Job Board" Language="C#" MasterPageFile="~/Contributor.Master" AutoEventWireup="true" CodeBehind="JobBoard.aspx.cs" Inherits="DDCH.JobBoard" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    <asp:Panel ID="pnlCanvas" runat="server" BackColor="#0F172A" Style="position: relative; width: 860px; height: 850px; padding: 20px;">
        <asp:Label ID="lblBreadcrumb" runat="server" Text="Home / Contributor / Job Board" ForeColor="#64748B" Font-Size="12px" Style="position: absolute; left: 20px; top: 10px;"></asp:Label>
