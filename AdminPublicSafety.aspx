    ...
    <asp:Panel ID="pnlCanvas" runat="server" BackColor="#0F172A" Style="position: relative; width: 860px; height: 850px; padding: 20px;">
        ...
        <asp:Panel ID="pnlContent" runat="server" BackColor="#1E293B" Style="position: absolute; left: 20px; top: 100px; width: 820px; height: 600px; border-radius: 8px; padding: 10px; overflow-y: auto;">
            ...
            <asp:Panel ID="pnlRow1" runat="server" Visible="false" Style="position: absolute; left: 0px; top: 40px; width: 820px; height: 60px; border-bottom: 1px solid #0F172A;">
                ...
                <asp:Label ID="lblStatus1" runat="server" Text="Pending" Style="position: absolute; left: 304px; top: 15px; color: #FCD34D; font-size: 12px; background-color: #451A03; padding: 5px 10px; border-radius: 4px;"></asp:Label>
                <asp:Button ID="btnApprove1" runat="server" Text="Approve" BackColor="#10B981" ForeColor="White" BorderStyle="None" Style="position: absolute; right: 288px; top: 14px; padding: 6px 12px; border-radius: 4px; cursor: pointer;" OnClick="btnApprove1_Click" />
                <asp:Button ID="btnDeactivate1" runat="server" Text="Deactivate" BackColor="#F59E0B" ForeColor="White" BorderStyle="None" Style="position: absolute; right: 120px; top: 15px; padding: 6px 12px; border-radius: 4px; cursor: pointer;" OnClick="btnDeactivate1_Click" />
            ...
            <asp:Panel ID="pnlRow2" runat="server" Visible="false" Style="position: absolute; left: 0px; top: 100px; width: 820px; height: 60px; border-bottom: 1px solid #0F172A;">
                ...
                <asp:Label ID="lblStatus2" runat="server" Text="Pending" Style="position: absolute; left: 307px; top: 25px; color: #FCD34D; font-size: 12px; background-color: #451A03; padding: 5px 10px; border-radius: 4px;"></asp:Label>
                <asp:Button ID="btnApprove2" runat="server" Text="Approve" BackColor="#10B981" ForeColor="White" BorderStyle="None" Style="position: absolute; right: 290px; top: 20px; padding: 6px 12px; border-radius: 4px; cursor: pointer;" OnClick="btnApprove2_Click" />
                <asp:Button ID="btnDeactivate2" runat="server" Text="Deactivate" BackColor="#F59E0B" ForeColor="White" BorderStyle="None" Style="position: absolute; right: 122px; top: 15px; padding: 6px 12px; border-radius: 4px; cursor: pointer;" OnClick="btnDeactivate2_Click" />
            ...
            <asp:Panel ID="pnlRow3" runat="server" Visible="false" Style="position: absolute; left: 0px; top: 160px; width: 820px; height: 60px; border-bottom: 1px solid #0F172A;">
                ...
                <asp:Label ID="lblStatus3" runat="server" Text="Pending" Style="position: absolute; left: 311px; top: 20px; color: #FCD34D; font-size: 12px; background-color: #451A03; padding: 5px 10px; border-radius: 4px;"></asp:Label>
                <asp:Button ID="btnApprove3" runat="server" Text="Approve" BackColor="#10B981" ForeColor="White" BorderStyle="None" Style="position: absolute; right: 290px; top: 16px; padding: 6px 12px; border-radius: 4px; cursor: pointer;" OnClick="btnApprove3_Click" />
                <asp:Button ID="btnDeactivate3" runat="server" Text="Deactivate" BackColor="#F59E0B" ForeColor="White" BorderStyle="None" Style="position: absolute; right: 129px; top: 17px; padding: 6px 12px; border-radius: 4px; cursor: pointer;" OnClick="btnDeactivate3_Click" />
