...
namespace DDCH
{
    public partial class Admin : System.Web.UI.Page
    {
        ...
        private void LoadDashboard()
        {
            ...
            lblPendingUsersCount.Text = DatabaseHelper.ExecuteScalar(userCountSql).ToString();

            string postCountSql = "SELECT COUNT(*) FROM Posts WHERE Status = 'Pending'";
            lblPendingPostsCount.Text = DatabaseHelper.ExecuteScalar(postCountSql).ToString();

            string activePostSql = "SELECT COUNT(*) FROM Posts WHERE Status = 'Approved'";
            lblActivePostsCount.Text = DatabaseHelper.ExecuteScalar(activePostSql).ToString();
