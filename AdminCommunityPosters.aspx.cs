...
namespace DDCH
{
    public partial class AdminCommunityPosters : System.Web.UI.Page
    {
        ...
        {
            DataTable dt = DatabaseHelper.ExecuteQuery("SELECT PostId, Title, Status, ImagePath FROM Posts WHERE Category = @cat ORDER BY CreatedAt DESC LIMIT 3", new SQLiteParameter("@cat", "Community Posters"));
