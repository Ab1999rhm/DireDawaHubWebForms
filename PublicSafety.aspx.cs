...
namespace DDCH
{
    public partial class PublicSafety : System.Web.UI.Page
    {
        ...
        protected void btnSubmit_Click(object sender, EventArgs e)
        {
            ...
            SQLiteParameter[] prms = {
                ...
                new SQLiteParameter("@cat", "Public Safety"),
        ...
        private void LoadMyPosts()
        {
            ...
            DataTable dt = DatabaseHelper.ExecuteQuery("SELECT PostId, Title, Status FROM Posts WHERE Category = @cat AND UserId = @uid ORDER BY CreatedAt DESC LIMIT 3", 
                new SQLiteParameter("@cat", "Public Safety"), new SQLiteParameter("@uid", userId));
